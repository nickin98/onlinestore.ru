...
return [
    ...
    */
    ...
    'custom' => [
        'payment' => [
            'required' => 'Не выбрана форма оплаты.',
            'integer' => 'Не выбрана форма оплаты.',
            'digits_between' => 'Некорректная форма оплаты.'
        ],
        'cart' => [
            'required' => 'Добавьте что-то в корзину, прежде чем оформлять заказ.',
            'json' => 'Добавьте что-то в корзину, прежде чем оформлять заказ.',
            'exist_product' => 'Ошибка с корзиной, попробуйте очистить кэш.',
        ],
        'delivery' => [
            'required' => 'Не выбрано время доставки.',
            'digits_between' => 'Некорректное время доствки.',
        ],
        'date' => [
            'required_if' => 'Поле дата обязательно для заполнения.',
        ],
        'time' => [
            'required_if' => 'Поле дата обязательно для заполнения.',
        ],
        'availability' => [
            'boolean' => 'Некорректное значение для поля Доступность.',
        ],
        'image' => [
            'dimensions' => 'Неправильный формат изображения. 
            Изображение должно иметь минмальную ширину и высоту в 400 пикселей,
            а также иметь отношение сторон 1 к 1(квадратная форма)'
        ]
    ],
